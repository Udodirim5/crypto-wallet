...
export default function BottomNav() {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#0c0f0e] border-t border-[#1e2322] pb-4 pt-2 px-10 z-50">
      <div className="flex justify-between">
        <button className="flex flex-col items-center">
          <IoMdHome className="h-6 w-6 text-[#3385ff]" />
          <span className="text-xs mt-1 text-[#3385ff]">Home</span>
        </button>
        <button className="flex flex-col items-center">
